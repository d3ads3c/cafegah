...
const footerLinks = {
  ...
  social: [
    {
      name: "اینستاگرام",
      href: "https://instagram.com/cafegah.ir",
      icon: (
    ...
    {
      name: "تلگرام",
      href: "https://t.me/cafegahofficial",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "لینکدین",
      href: "https://www.linkedin.com/company/cafegah",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex w-full flex-wrap items-center gap-4 justify-end mt-8 sm:mt-10">
          <div className="size-32 rounded-2xl p-3 bg-white">
            <Link
              ...
              target="_blank"
              href="https://trustseal.enamad.ir/?id=4552683&Code=qyknEybElaLSRGJsWgxcqOV4NJYZ6aal"
            >
              <Image
                src={"/img/enamad.png"}
                width={1000}
          ...
          <div className="size-32 rounded-2xl p-3 bg-white">
            <Link
              target="_blank"
              href="https://gateway.zibal.ir/trustMe/cafegah.ir"
            >
              <Image
                src={"/img/zibal.jpg"}
                width={1000}
