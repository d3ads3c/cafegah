...
const features = [
  ...
  },
  {
    ...
    desc: "سیستم حسابداری کامل با ثبت سند، مدیریت حساب و ...",
    plans: ["ویژه"],
  },
  {
    id: 7,
  ...
  },
  {
    ...
    category: "مشتریان",
    name: "گزارش مشتریان",
    desc: "مشاهده تعداد سفارشات، مجموع خرید و بدهکاری",
    plans: ["حرفه‌ای", "ویژه"],
  },
  {
    id: 12,
    category: "مشتریان",
    name: "تخفیف اختصاصی",
    desc: "تعریف تخفیف اخصاصی به تکفیف مشتریان به صورت درصد و یا مبلغ",
    plans: ["حرفه‌ای", "ویژه"],
  },
  {
    id: 13,
  ...
  },
  {
    ...
    category: "دسترسی",
    name: "تحت وب",
    desc: "دسترسی به پنل مدیریت از هرکجا با هر دستگاه",
    plans: ["حرفه‌ای", "ویژه", "پایه"],
  },
  {
    id: 15,
  ...
  },
  {
    ...
    category: "پشتیبانی",
    name: "پشتیبانی ویژه",
    desc: "پشتیبانی تلفنی و آنلاین 24 ساعته",
    plans: ["پایه", "حرفه‌ای", "ویژه"],
  },
];
...
const PricingTable: React.FC = () => {
  ...
  return (
    <section
      id="prices"
      className="mx-2 sm:mx-6 md:mx-16 lg:mx-40 my-10 sm:my-14 md:my-16 relative"
    >
      ...
      <div className="sticky top-0 z-10 pt-4 sm:pt-6 pb-6 sm:pb-8 -mx-2 sm:-mx-6 md:-mx-8 px-2 sm:px-6 md:px-8 rounded-2xl backdrop-blur-xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          <div className="col-span-1 mb-4 md:mb-0">
            <div className="w-full min-h-full bg-teal-600 shadow-xl shadow-teal-600/40 text-white rounded-3xl p-5 sm:p-8 flex items-center justify-center">
              <div>
                ...
                <p className="text-justify my-2 sm:my-3 text-xs sm:text-base">
                  میتوانید به صورت رایگان برای سیستم مدیریت کافه خود مشاوره
                  دریافت کنید
                </p>
                <div className="text-center">
                  <button className="text-teal-600 bg-white rounded-2xl py-2 px-4 sm:py-2.5 sm:px-6 shadow-xl shadow-white/20 font-bold text-xs sm:text-base">
                    تماس با ما
                  </button>
                </div>
              </div>
          ...
          {plans.map((plan, idx) => (
            <div
              key={idx}
              className={`col-span-1 bg-white rounded-3xl border border-gray-200 p-5 sm:p-8 shadow-xl ${
                plan.highlight ? "border-teal-600 md:scale-105" : ""
              }`}
            >
              <h3
                className={`text-lg sm:text-xl font-bold mb-2 ${
                  plan.highlight ? "text-teal-600" : ""
                }`}
              >
                {plan.title}
              </h3>
        ...
        <div className="min-w-[600px] md:min-w-0">
          <div className="grid grid-cols-4 gap-4 sm:gap-6">
            <div className="col-span-1">
              <h3 className="text-base sm:text-lg font-bold text-gray-700 mb-4 sm:mb-6">
                امکانات و ویژگی‌ها
              </h3>
            </div>
            {plans.map((plan, idx) => (
              <div key={idx} className="col-span-1">
                <h4
                  className={`text-sm sm:text-md font-bold mb-4 sm:mb-6 ${
                    plan.highlight ? "text-teal-600" : "text-gray-700"
                  }`}
                >
                  {plan.title}
                </h4>
          ...
          {Object.entries(
            ...
            ([category, categoryFeatures], categoryIndex, categoriesArray) => (
              <div
                key={category}
                className={
              ...
              >
                <div className="grid grid-cols-4 gap-4 sm:gap-6 py-4 sm:py-6">
                  <div className="col-span-1">
                    <h4 className="text-sm sm:text-md font-bold text-teal-600 mb-2 sm:mb-4">
                      {category}
                    </h4>
                  </div>
                </div>
                {categoryFeatures.map((feature, featureIndex) => (
                  <div
                    key={feature.id}
                    className="grid grid-cols-4 gap-4 sm:gap-6 py-2 sm:py-3"
                  >
                    <div className="col-span-1">
                      <div className="font-bold text-gray-700 mb-1 text-xs sm:text-base">
                        {feature.name}
                      </div>
                      ...
                      >
                        {feature.plans.includes(plan.key) ? (
                          <div className="flex items-center">
                            ...
                            <span className="text-xs sm:text-sm text-gray-700 mr-2">
                              دارد
                            </span>
                          </div>
                        ) : (
